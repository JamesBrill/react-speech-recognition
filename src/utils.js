...
const stringSimilarityRatioFunction = (
  s1,
  s2,
  comparisonFn = compareTwoStringsUsingDiceCoefficient
) => {
  const s1ToUpperCase = s1.toUpperCase()
  const s2ToUpperCase = s2.toUpperCase()
  return comparisonFn(s1ToUpperCase, s2ToUpperCase)
}
